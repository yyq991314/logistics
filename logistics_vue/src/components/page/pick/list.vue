    ...
    <div>
            ...
            >
                ...
                <el-table-column label="状态" width="80" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-tag type="danger" plain v-if="scope.row.orders==6">待取件</el-tag>
                        <el-tag type="danger" plain v-if="scope.row.orders==7">预约取件</el-tag>
                        <el-tag type="danger" plain v-if="scope.row.orders==8">已签收</el-tag>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" width="160" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button
                                ...
                                type="text"
                                icon="el-icon-location-information"
                                @click="endOrder(scope.$index, scope.row)"
                        >预约取件
                        </el-button>
                        <el-button
        ...
        <el-dialog :title="form._sn" :visible.sync="logVisible" width="50%">
            <el-form ref="form" :model="form" label-width="120px">
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitLog">更新物流</el-button>
                </el-form-item>
            </el-form>
            <div class="crumbs">
                <el-breadcrumb separator="/">
        ...
        <!-- 预约取件弹出框 -->
        <el-dialog :title="form._sn" :visible.sync="appVisible" width="50%">
            <el-form ref="arr" :rules="rules" :model="form" label-width="120px">
                <div class="crumbs">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item>
                            <i class="el-icon-lx-notice" style="color:#409EFF;"></i> 提示
                        </el-breadcrumb-item>
                        <el-breadcrumb-item>选择取件时间</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <el-form-item label="日期时间" prop="apptime1">
                    <el-date-picker
                            type="datetime"
                            placeholder="选择日期"
                            v-model="form.apptime1"
                ...
                <el-form-item label="取件备注">
                    <el-input type="textarea" rows="5" v-model="form.appmark"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="submitApp">立即预约</el-button>
...
<script>
    import {fetchList} from '../../../api/pick';
    import Qs from 'qs';
    ...
    export default {
        ...
        data() {
            return {
                ...
                activities: [],
                rules: {
                    apptime1: [{required: true, message: '请选择预约日期时间', trigger: 'blur'}],
                },
            };
        },
        created() {
        ...
        methods: {
            ...
            arrOrder(index, row) {
                ...
                this.id = row.id;
                this.form = row;
                this.$confirm('确定要揽收入库么？', '温馨提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    if (this.form.orders != 5) {
                        this.$message.error("该订单物品已经揽收入库");
                        return false;
                    }
                    this.form.username = localStorage.getItem('ms_username');
                    arrOrder(this.form).then(res => {
                        if (res.status == 1) {
