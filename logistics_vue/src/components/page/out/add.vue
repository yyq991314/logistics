    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>快递寄件</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                <el-form ref="add" :rules="rules" :model="form" label-width="160px">
                    ...
                    <div class="crumbs">
                        <el-breadcrumb separator="/">
                            ...
                            <el-breadcrumb-item>寄件备注</el-breadcrumb-item>
                        </el-breadcrumb>
                    </div>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    mtelephone: [{required: true, message: '请输入寄件人电话', trigger: 'blur'}],
                    maddress: [{required: true, message: '请输入寄件人地址', trigger: 'blur'}],
                    rname: [{required: true, message: '请输入收件人姓名', trigger: 'blur'}],
                    rtelephone: [{required: true, message: '请输入收件人电话', trigger: 'blur'}],
